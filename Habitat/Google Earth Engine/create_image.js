...
var collection = ee.ImageCollection(collectionId)
    .filterBounds(roi)
    .filterDate('2021-05-01', '2021-06-29');
 ...
 *      computeNDVI
 * @description
 *      Calculates NDVI index, amount of vegatation
 */
 ...
 *      computeNDWI
 * @description
 *      Calculates NDWI index, amount of water || error in this function
 */
...
Export.image.toAsset({
    image: mosaic,
    description: 'mpala-2021-summer',
    assetId: 'mpala-2021-summer',
