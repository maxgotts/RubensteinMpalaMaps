...
for (date_id in 1:nrow(dates)) {
  ...
  # Add NDVI
  NDVI_raster <- raster(paste0("/Users/maxgotts/Desktop/MPALA/Maps/VI Data/frames/mpala-NDVI-",start,".tif"))
  ...
  EVI_raster <- raster(paste0("/Users/maxgotts/Desktop/MPALA/Maps/VI Data/frames/mpala-EVI-",start,".tif"))
...
# for (pixel_id in 1:nrow(Habitat)) {
#   print(pixel_id)
# }
...
cat("Writing...\n")
write.csv(Habitat,"/Users/maxgotts/Desktop/MPALA/Maps/TIFFs.csv",row.names=FALSE)


if (FALSE) {
  source("/Users/maxgotts/Desktop/MPALA/Maps/ProcessTIFFs.R")
}
